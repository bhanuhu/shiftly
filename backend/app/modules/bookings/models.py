...
from app.shared.enums import BookingStatus, BookingType, enum_values
...
class Booking(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    booking_type: Mapped[BookingType] = mapped_column(
        Enum(BookingType, name="booking_type", values_callable=enum_values), default=BookingType.EXPRESS
    )
    status: Mapped[BookingStatus] = mapped_column(
        Enum(BookingStatus, name="booking_status", values_callable=enum_values), default=BookingStatus.PENDING
    )
